...
type SolanaSignMessageRpcInputType = WithWalletIdOrAddressChainType<{
 ...
 */
type SolanaSignTransactionRpcInputType<TTransactionType extends Transaction | VersionedTransaction = VersionedTransaction | Transaction> = WithWalletIdOrAddressChainType<SolanaBaseTransactionRpcInputType<TTransactionType> & {
    /** RPC method to execute with the wallet.  */
 ...
 * Otherwise, the `rpc` method will determine the type of transaction you passed in and return the appropriate type.
 */
type SolanaSignAndSendTransactionRpcInputType<TTransactionType extends Transaction | VersionedTransaction = VersionedTransaction | Transaction> = WithWalletIdOrAddressChainType<SolanaBaseTransactionRpcInputType<TTransactionType> & {
    /** RPC method to execute with the wallet.  */
...
type EthereumSignTypedDataRpcInputType = WithWalletIdOrAddressChainType<{
    /** RPC method to execute with the wallet.  */
...
type EthereumPersonalSignRpcInputType = WithWalletIdOrAddressChainType<{
    /** RPC method to execute with the wallet.  */
...
type EthereumSignTransactionRpcInputType = WithWalletIdOrAddressChainType<EthereumBaseTransactionRpcInputType & {
    /** RPC method to execute with the wallet.  */
    method: 'eth_signTransaction';
}, 'ethereum'>;
type EthereumSendTransactionRpcInputType = WithWalletIdOrAddressChainType<EthereumBaseTransactionRpcInputType & {
    /** RPC method to execute with the wallet.  */
...
/**
 * CAIP-2 chain IDs for EVM networks. These are prefixed with 'eip155:'
 * followed by the canonical EVM chain ID. As an example, the CAIP-2
 * chain ID for Ethereum Mainnet is 'eip155:1'.
 */
...
declare class WalletApi {
    ...
    private mode;
    constructor({ appId, api, authorizationPrivateKey, mode, }: {
        /** Privy app ID */
        appId: string;
        ...
        /**
         * Mode for using the Privy Client to interface with the Privy wallet API.
         *
         * If your app is using delegated actions (where a user creates their embedded
         * wallet and delegates access to your server), set this field to `'delegated-actions'`.
         *
         * Otherwise, leave the `mode` blank.
         **/
        mode: 'delegated-actions' | 'wallet-api';
    });
    create({ chainType, }: {
        chainType: 'ethereum' | 'solana';
     ...
     */
    rpc(input: SolanaSignTransactionRpcInputType<Transaction>): Promise<WalletApiSolanaSignTransactionRpcResponseType<Transaction>>;
    rpc(input: SolanaSignTransactionRpcInputType<VersionedTransaction>): Promise<WalletApiSolanaSignTransactionRpcResponseType<VersionedTransaction>>;
    rpc(input: SolanaSignTransactionRpcInputType): Promise<WalletApiSolanaSignTransactionRpcResponseType>;
    rpc(input: SolanaSignAndSendTransactionRpcInputType<Transaction>): Promise<WalletApiSolanaSignAndSendTransactionRpcResponseType>;
    rpc(input: SolanaSignAndSendTransactionRpcInputType<VersionedTransaction>): Promise<WalletApiSolanaSignAndSendTransactionRpcResponseType>;
    rpc(input: SolanaSignAndSendTransactionRpcInputType): Promise<WalletApiSolanaSignAndSendTransactionRpcResponseType>;
    rpc(input: SolanaSignMessageRpcInputType): Promise<WalletApiSolanaSignMessageRpcResponseType>;
    rpc(input: EthereumSignTransactionRpcInputType): Promise<WalletApiEthereumSignTransactionRpcResponseType>;
    rpc(input: EthereumPersonalSignRpcInputType): Promise<WalletApiEthereumPersonalSignRpcResponseType>;
    rpc(input: EthereumSignTypedDataRpcInputType): Promise<WalletApiEthereumSignTypedDataRpcResponseType>;
    rpc(input: EthereumSendTransactionRpcInputType): Promise<WalletApiEthereumSendTransactionRpcResponseType>;
}
...
declare class PrivyClient {
    ...
    /**
     * @deprecated For performance reasons, we recommend getUser({idToken: string}) to avoid rate limits as your app scales.
     *
...
export { AllowlistEntry, AppSettings, Apple, AppleOAuthWithMetadata, AuthTokenClaims, CustomJwt, CustomJwtWithMetadata, Discord, DiscordOAuthWithMetadata, Email, EmailWithMetadata, EthereumPersonalSignRpcInputType, EthereumSendTransactionRpcInputType, EthereumSignTransactionRpcInputType, EthereumSignTypedDataRpcInputType, EvmCaip2ChainId, Farcaster, FarcasterWithMetadata, Github, GithubOAuthWithMetadata, Google, GoogleOAuthWithMetadata, ImportUserInput, Instagram, InstagramOAuthWithMetadata, LinkedAccountWithMetadata, LinkedIn, LinkedInOAuthWithMetadata, Phone, PhoneWithMetadata, PrivyClient, SolanaCaip2ChainId, SolanaSignAndSendTransactionRpcInputType, SolanaSignMessageRpcInputType, SolanaSignTransactionRpcInputType, Spotify, SpotifyOAuthWithMetadata, Telegram, TelegramWithMetadata, Tiktok, TiktokOAuthWithMetadata, Twitter, TwitterOAuthWithMetadata, User, Wallet, WalletApiCreateResponseType, WalletApiEthereumPersonalSignRpcResponseType, WalletApiEthereumSendTransactionRpcResponseType, WalletApiEthereumSignTransactionRpcResponseType, WalletApiEthereumSignTypedDataRpcResponseType, WalletApiRpcInputType, WalletApiRpcResponseType, WalletApiSolanaSignAndSendTransactionRpcResponseType, WalletApiSolanaSignMessageRpcResponseType, WalletApiSolanaSignTransactionRpcResponseType, WalletWithMetadata };
